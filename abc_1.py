...
if __name__ == "__main__":
    # Contract data entered by contractor and farmer
    contract_data = {
    "contract_id": "123456",
    "buyer_name": "GSFC Agro Ltd.",
    "seller_name": "Ayush Devani",
    "buyer_address": "123 Agro Street, Cityville",
    "agreement_duration": "2 years",
    "start_date": "2024-12-10",
    "end_date": "2026-12-10",
    "jurisdiction": "Savarkundla",
    "legal_location": "Amreli",
    "seeds": "Hybrid maize seeds",
    "fertilizers": "Nitrogen-rich fertilizer",
    "pesticides": "Organic pesticide",
    "other_support": "Technical support on crop management",
    "delivery_date": "2024-12-15",
    "land_size": "10 acres",
    "farm_address": "456 Greenfield Road, Countryside",
    "irrigation_type": "Drip irrigation",
    "land_features": "Flat terrain, moderate soil fertility",
    "other_facilities": "Storage shed, farm equipment",
    "crop_name": "Maize",
    "crop_variety": "Hybrid Maize",
    "produce_quantity": "50 tons",
    "physical_appearance": "Uniform and healthy grains",
    "moisture_content": "12%",
    "quality_parameters": "No visible pests or diseases",
    "testing_method": "Lab testing",
    "dispute_resolution_method": "Mediation or Arbitration",
    "delivery_pickup_address": "XYZ Agro Warehouse, Cityville",
    "delivery_location": "XYZ Agro Warehouse, Cityville",
    "delivery_timeline": "30 days from harvest",
    "pricing_structure": "₹25 per kg",
    "guaranteed_price": "₹25 per kg",
    "deposit_percentage": "20",
    "market_price_multiplier": "1.5",
    "retention_percentage": "0.5",
    "retention_amount": "25",
    "new_total_price": "125",
    "additional_profit_percentage": "25",
    "additional_payment": "25",
    "late_payment_penalty": "2",
    "force_majeure_evidence": "Government reports, weather data",
    "last_updated_date": "2024-12-01",
    "contact_information": "krishisarthofficial@gmail.com, +91-8780557462"
}
    ...
    sender_password = "tlmc arid zudz yeac"  # Use app password if 2FA is enabled
    contractor_email = "ayushdevani0018@gmail.com"  # Replace with actual email
    farmer_email = "22bt04105@gsfcuniversity.ac.in"  # Replace with actual email
    email_subject = "Approved Contract: Assured Contract Farming"
    ...
    send_contract_email(sender_email, sender_password, farmer_email, email_subject, email_body, pdf_path, sender_name)
